...
import com.polaris.ipv6.view.viewActivity.AreaActivity;
...
public class AreaFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.frag_area, container, false);
        Button areaBtn = view.findViewById(R.id.area_btn);

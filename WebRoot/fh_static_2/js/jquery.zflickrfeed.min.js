...
(function($){$.fn.flickrfeed=function(userid,tags,options){var defaults={limit:10,imagesize:'small',titletag:'h4',title:true,date:true};var options=$.extend(defaults,options);return this.each(function(i,e){var $e=$(e);var api='';if(userid!='')api+='&id='+userid;if(tags!='')api+='&tags='+tags;$.getJSON(api,function(data){_callback(e,data,options);});});};var _callback=function(e,data,options){if(!data){return false;}

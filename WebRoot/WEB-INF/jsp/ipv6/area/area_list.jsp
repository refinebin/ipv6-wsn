...
<body class="no-skin">
						...
						<table id="simple-table" class="table table-striped table-bordered table-hover" style="margin-top:5px;">	
							<thead>
								<tr>
									...
									<th style="display: none" class="center">区域ID</th>
									<th class="center">区域名称</th>

									<%--<th class="center">修改时间</th>--%>
									<%--<th class="center">创建时间</th>--%>
									<%--<th class="center">是否删除</th>--%>
									<th class="center">区域负责人</th>
								...
								<c:when test="${not empty varList}">
									...
									<c:forEach items="${varList}" var="var" varStatus="vs">
										<tr>
											...
											<td style="display: none" class='center'>${var.AREA_ID}</td>
											...
											<td class="center">
												...
												<div class="hidden-sm hidden-xs btn-group">
													...
													<c:if test="${QX.edit == 1 }">
														...
														<a class="btn btn-xs btn-primary" title="实时数据" onclick="record('${var.AREA_ID}');">
															<i class="ace-icon fa fa-bar-chart-o bigger-120" title="实时数据"></i>
														</a>
													</c:if>
													<c:if test="${QX.del == 1 }">
	...
	<script type="text/javascript">
        ...
        function record(Id){
            ...
            diag.Drag=true;
            diag.Title ="监控查看";
            diag.URL = '<%=basePath%>area/goRecord.do?AREA_ID='+Id;
            diag.Width = 800;
            diag.Height = 500;
            diag.Modal = true;				//有无遮罩窗口
            diag. ShowMaxButton = true;	//最大化按钮

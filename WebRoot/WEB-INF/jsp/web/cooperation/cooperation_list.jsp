...
<body class="no-skin">
			...
			<div class="main-content-inner">
				<div class="page-content">
					<div class="row">
						...
						<!-- 检索  -->
						<form action="cooperation/list.do" method="post" name="Form" id="Form">
						<!-- 检索  -->
							...
							<c:choose>
								<c:when test="${not empty varList}">
									...
									<c:forEach items="${varList}" var="var" varStatus="vs">
										...
										<tr>
											<td>
												<a class="btn btn-xs btn-success" title="编辑" onclick="edit('${var.COOPERATION_ID}');">
	...
	<script type="text/javascript">
		...
		function edit(Id){
			 ...
			 diag.Drag=true;
			 diag.Title ="编辑";
			 diag.URL = '<%=basePath%>cooperation/goEdit.do?COOPERATION_ID='+Id;
			 diag.Width = 800;
			 diag.Height = 600;

package com.fh.controller.ipv6.area;
...
public class AreaController extends BaseController {
	...
	public ModelAndView list(Page page) throws Exception{
		...
		mv.setViewName("ipv6/area/area_list");
	...
	public ModelAndView goAdd()throws Exception{
		...
		pd = this.getPageData();
		mv.setViewName("ipv6/area/area_edit");
	...
	public ModelAndView goRecord()throws Exception{
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		mv.setViewName("ipv6/area/area_record");
		mv.addObject("msg", "save");
		mv.addObject("pd", pd);
		return mv;
	}
	...
	public ModelAndView exportExcel() throws Exception{
		...
		for(int i=0;i<varOList.size();i++){
			...
			vpd.put("var1", varOList.get(i).get("AREA_ID").toString());	//1
			vpd.put("var2", varOList.get(i).getString("AREA_NAME"));	    //2
			vpd.put("var3", varOList.get(i).getString("MODIFY_TIME"));	    //3
			vpd.put("var4", varOList.get(i).getString("CREATE_TIME"));	    //4
			vpd.put("var5", varOList.get(i).get("IS_DELETE").toString());	//5
			varList.add(vpd);
		}

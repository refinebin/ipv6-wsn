                            ...
                            <c:if test="${QX.cha == 1 }">
                                ...
                                <tr>
                                    <td class='center' style="width: 30px;">
                                        <label><input type='checkbox' name='ids' class="ace"  /><span class="lbl"></span></label>
                                    </td>

                                    <td class="center">
                                        <a href="<%=basePath%>uploadFiles/uploadImgs/20190108/lab5.jpg" title="7教5楼缩略图" class="bwGal"><img src="<%=basePath%>uploadFiles/uploadImgs/20190108/lab5.jpg" alt="7教5楼缩略图" width="100"></a>
                                    </td>
                                    <td class="center">7教</td>
                                    <td class="center">5楼</td>
                                    <td class="center" style="width:130px;">

                                        <c:if test="${QX.edit == 1 }">
                                            <a style="cursor:pointer;" class="green" onclick="edit(5);" title="编辑">
...
<script type="text/javascript">
    ...
    function edit(Id){
        ...
        diag.Drag=true;
        diag.Title ="编辑";
        diag.URL = '<%=basePath%>lab/goEdit.do?id='+Id;
        diag.Width = 1400;
        diag.Height = 2000;
        diag.CancelEvent = function(){ //关闭事件
